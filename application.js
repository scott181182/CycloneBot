...
var Application = (function () {
    ...
    Application.prototype.start = function () {
        var _this = this;
        if (config_1["default"].has("ssl")) {
            var options = {
                cert: fs_1.readFileSync(config_1["default"].getPath("ssl.cert")),
                key: fs_1.readFileSync(config_1["default"].getPath("ssl.key"))
            };
            https_1.createServer(options, this.app).listen(this.app.get("port:https"), function () {
                logger.info("Server running in HTTPS!\n" +
                    ("   Port: " + _this.app.get("port:https") + "\n") +
            ...
            http_1.createServer(function (req, res) {
                ...
                res.end("<html><head><title>Moved</title></head>" +
                    "<body><h1>Moved</h1>" +
